---
title: Building a slash command
description: This guide allows to build slash commands
sidebar_position: 5
---
...
## Basic command
Here is an basic example of a slash command

```javascript
const Yag = require("yags.js")

// Replace TOKEN with your bot account's token
const bot = new Yag.CommandClient(
  "Bot TOKEN",
  {},
  {
    description: "A test bot made with Yag",
    owner: "somebody",
    prefix: "!",
  },
)
